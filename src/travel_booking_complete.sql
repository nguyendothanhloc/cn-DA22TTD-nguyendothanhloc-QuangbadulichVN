-- ============================================
-- TRAVEL BOOKING SYSTEM - COMPLETE DATABASE
-- ============================================
-- File này sẽ tự động:
-- 1. Tạo database travel_booking
-- 2. Tạo tất cả các bảng
-- 3. Import dữ liệu mẫu
-- 
-- Cách sử dụng:
-- mysql -u root -p < travel_booking_complete.sql
-- ============================================
...
CREATE TABLE IF NOT EXISTS `tours` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `idx_tours_departure` (`departure_date`),
  KEY `idx_tours_place` (`place_id`),
  CONSTRAINT `tours_ibfk_1` FOREIGN KEY (`place_id`) REFERENCES `places` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE `places` AUTO_INCREMENT=11;
ALTER TABLE `tours` AUTO_INCREMENT=22;
...
-- HOÀN TẤT
-- ============================================
-- Database đã được tạo và import dữ liệu thành công!
-- 
